...
/**
 * <p>Clase Java para getWrittenOpinionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getWrittenOpinionResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getWrittenOpinionResponse", propOrder = {
    "_return"
})
public class GetWrittenOpinionResponse {
