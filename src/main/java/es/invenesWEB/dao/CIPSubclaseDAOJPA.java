...
public class CIPSubclaseDAOJPA implements CIPSubclaseDAO {
	/** Logger */
	private Logger log = Logger.getLogger(CIPSubclaseDAOJPA.class);
	
	EntityManager em;
	
	@Override
	public List<CIPSubClase> obtenerTodasClase(String idClase) throws Exception {
		StringBuffer sql = new StringBuffer("SELECT t FROM CIPSubClase t  WHERE idClase='"+idClase+"' ORDER BY idSubclase");		
